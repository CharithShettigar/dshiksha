...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Accountant',
            fields=[
                ('AccountantID', models.UUIDField(default=uuid.uuid4, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Accountant', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='school.accountant')),
                ('Area', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='dshiksha_erp.area')),
                ('Correspondent', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='dshiksha_erp.correspondent')),
                ('CurrentAcademicYear', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='dshiksha_erp.academicyear')),
                ('Parish', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='dshiksha_erp.parish')),
                ('Pincode', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='dshiksha_erp.postoffice')),
                ('Syllabus', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='dshiksha_erp.syllabustype')),
                ('UserID', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
