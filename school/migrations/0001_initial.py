    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Class', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='school.class')),
                ('Installment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='dshiksha_erp.installment')),
                ...
                ('School', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='school.school')),
                ('Section', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='dshiksha_erp.section')),
            ],
        ),
        migrations.CreateModel(
            name='Chapter',
