...
class School(models.Model):
    ...
    SchoolDISECode = models.CharField(max_length=11)
    ...
    AccountantMobile = models.CharField(max_length=10)
    AccountantWhatsAppNo = models.CharField(max_length=10)

    CorrespondentName = models.CharField(max_length=100)
    CorrespondentEmail = models.EmailField(max_length=100)
    CorrespondentMobile = models.CharField(max_length=10)
    CorrespondentWhatsAppNo = models.CharField(max_length=10)
...
class Staff(models.Model):
    ...
    StaffWhatsAppNo = models.CharField(max_length=10)
...
class Application(models.Model):
    ...
    Gender = models.ForeignKey(erp.Gender, on_delete=models.CASCADE, null=True)
    StudentMobileNo = models.CharField(max_length=10)
    ParentName = models.CharField(max_length=100)
    ParentMobileNo = models.CharField(max_length=10)
    Class = models.ForeignKey(Class, on_delete=models.CASCADE)
    SchoolID = models.ForeignKey(School, on_delete=models.CASCADE)
...
class Students(models.Model):
    ...
    FatherMobileNo = models.CharField(max_length=10,null=True,blank=True)
    FatherWhatsappNo = models.CharField(max_length=10,null=True,blank=True)
    FatherEmail = models.EmailField(max_length=100,null=True,blank=True)
    FatherQualification = models.CharField(max_length=100,null=True,blank=True)
    FatherOccupation = models.CharField(max_length=100,null=True,blank=True)
    FatherIncome = models.FloatField(null=True,blank=True)

    # Mother info
    MotherName = models.CharField(max_length=100,null=True,blank=True)
    MotherMobileNo = models.CharField(max_length=10,null=True,blank=True)
    MotherWhatsappNo = models.CharField(max_length=10,null=True,blank=True)
    MotherEmail = models.EmailField(max_length=100,null=True,blank=True)
    MotherQualification = models.CharField(max_length=100,null=True,blank=True)
    MotherOccupation = models.CharField(max_length=100,null=True,blank=True)
    MotherIncome = models.FloatField(null=True,blank=True)

    # Guardian info
    GaurdianName = models.CharField(max_length=100,null=True,blank=True)
    GaurdianMobileNo = models.CharField(max_length=10,null=True,blank=True)
    GaurdianWhatsappNo = models.CharField(max_length=10,null=True,blank=True)
    GaurdianEmail = models.EmailField(max_length=100,null=True,blank=True)
    GaurdianQualification = models.CharField(max_length=100,null=True,blank=True)
    GaurdianOccupation = models.CharField(max_length=100,null=True,blank=True)
    GaurdianIncome = models.FloatField(null=True,blank=True)
