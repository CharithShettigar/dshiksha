...
class Students(models.Model):
    ...
    FatherMobileNo = models.CharField(max_length=100,null=True,blank=True)
    FatherWhatsappNo = models.CharField(max_length=100,null=True,blank=True)
    ...
    MotherMobileNo = models.CharField(max_length=100,null=True,blank=True)
    MotherWhatsappNo = models.CharField(max_length=100,null=True,blank=True)
    ...
    GaurdianMobileNo = models.CharField(max_length=100,null=True,blank=True)
    GaurdianWhatsappNo = models.CharField(max_length=100,null=True,blank=True)
