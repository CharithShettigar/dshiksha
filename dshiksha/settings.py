"""
Django settings for dshiksha project.
...
SECRET_KEY = 'django-insecure-f$6j)8^w-9m!&8bj2=vio1-xq#lcjnsx)4b$wz2ce^=upn+bpu'
...
WSGI_APPLICATION = 'dshiksha.wsgi.application'
